...
public class DbToCsvBatchConfig {
    ...
    public String getReaderNameComponent() {
        return readerNameComponent;
    }

    public void setReaderNameComponent(String readerNameComponent) {
        this.readerNameComponent = readerNameComponent;
    }
    ...
    public String getClasspathUserMerge() {
        return classpathUserMerge;
    }

    public void setClasspathUserMerge(String classpathUserMerge) {
        this.classpathUserMerge = classpathUserMerge;
    }
}
